...
# Draw barplot
drawBarplot <- function(type, title, xlab, ylab, feature) {
  count <- c()
  for(s in type) {
    value <- length(userprofile_df[which(userprofile_df[,feature] == s),feature])
...
ylab <- "User count"
feature <- "smoker"
drawBarplot(smoker_type, title, xlab, ylab, feature)
```
...
ylab <- "User count"
feature <- "drink_level"
drawBarplot(drink_level_type, title, xlab, ylab, feature)
```
...
drawBarplot(dress_preference_type, title, xlab, ylab, feature)
```
...
ylab <- "User count"
feature <- "ambience"
drawBarplot(ambience_type, title, xlab, ylab, feature)
```
...
ylab <- "User count"
feature <- "transport"
drawBarplot(transport_type, title, xlab, ylab, feature)
```
...
drawBarplot(marital_status, title, xlab, ylab, feature)
```
...
ylab <- "User count"
feature <- "hijos"
drawBarplot(hijos, title, xlab, ylab, feature)
```
...
ylab <- "User count"
feature <- "interest"
drawBarplot(interest, title, xlab, ylab, feature)
```
...
ylab <- "User count"
feature <- "personality"
drawBarplot(personality, title, xlab, ylab, feature)
```
...
ylab <- "User count"
feature <- "religion"
drawBarplot(religion, title, xlab, ylab, feature)
```
...
ylab <- "User count"
feature <- "activity"
drawBarplot(activity, title, xlab, ylab, feature)
```
...
ylab <- "User count"
feature <- "color"
drawBarplot(color, title, xlab, ylab, feature)
```
...
ylab <- "User count"
feature <- "budget"
drawBarplot(budget_type, title, xlab, ylab, feature)
```
