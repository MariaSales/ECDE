...
barplot(countSmoker, main = "Smoker type by total of users", xlab = "Smoker type", ylab = "User count", names.arg = smoker_type)
```
...
barplot(countDrinkLevel, main = "Drink level", xlab = "Drink level type", ylab = "User count", names.arg = drink_level_type)
```

3. Feature 'drink_level'
```{r}
drink_level_type <- c("abstemious", "casual drinker", "social drinker")
countDrinkLevel <- c()
for(s in drink_level_type) {
